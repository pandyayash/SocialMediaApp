package aayushiprojects.greasecrowd.firebase;
...
import aayushiprojects.greasecrowd.activities.MyJobsGarageActivity;
import aayushiprojects.greasecrowd.activities.StaticScreen;
...
import aayushiprojects.greasecrowd.helper.helper;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void generateChatMEssage(JSONObject jsonObject, String flag) {
        ...
        NotificationCompat.Builder builder = (NotificationCompat.Builder) new NotificationCompat.Builder(
                this)
                .setSmallIcon(R.drawable.tempbg)
