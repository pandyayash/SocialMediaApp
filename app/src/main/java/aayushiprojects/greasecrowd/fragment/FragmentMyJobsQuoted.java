...
import aayushiprojects.greasecrowd.adapter.AdptQuotedJobs;
...
public class FragmentMyJobsQuoted extends Fragment {
    public String TAG = "FragmentMyJobsQuoted";
    Activity appContext;
    RecyclerView jobsRecyclerview;
    TextView textView;
    AdptQuotedJobs adptQuotedJobs;
...
*/
    ...
    public void setData() {
        ...
        if (postedJobDboArrayList.size() > 0) {
            ...
            adptQuotedJobs = new AdptQuotedJobs(postedJobDboArrayList, appContext);
            ...
            jobsRecyclerview.setAdapter(adptQuotedJobs);
