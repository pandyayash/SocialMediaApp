...
public class MyCrowd_DBO {
    ...
    public String getRespinses() {
        return responses;
    }

    public void setRespinses(String responses) {
        this.responses = responses;
    }

    String is_emergency, is_help, is_insurance, insurance_company, policy_number, claim_number, job_status, assigned_to_garage, uu_id, fname, lname, username, address1, address2, street_type, suburb, state, postcode, telephone, mobile, acc_type, referral_code, lat, lng, image, join_date, is_newsletter_subscribed, active, attempts, alert, sms_alert, push_not_alert;
    ...
    public String getIs_newsletter_subscribed() {
        return is_newsletter_subscribed;
    }

    public void setIs_newsletter_subscribed(String is_newsletter_subscribed) {
        this.is_newsletter_subscribed = is_newsletter_subscribed;
    }
