...
public class FragmentGarageQuotedJobs extends Fragment {
    ...
    public void setData() {
        ...
        if (((MyJobsGarageActivity) appContext).postedJobDboArrayList.size() > 0) {
            textView.setVisibility(View.GONE);
            jobsRecyclerview.setVisibility(View.VISIBLE);
            adptNewPostedJobs = new AdptNewPostedJobs(((MyJobsGarageActivity) appContext).postedJobDboArrayList, appContext);
