...
public class FragmentGarageAwardedJobs extends Fragment {
    ...
    public void setData() {
        if (((MyJobsGarageActivity) appContext).postedJobDboArrayList_Awarded.size() > 0) {
            textView.setVisibility(View.GONE);
            jobsRecyclerview.setVisibility(View.VISIBLE);
            adptNewPostedJobs = new AdptNewPostedJobs(((MyJobsGarageActivity) appContext).postedJobDboArrayList_Awarded, appContext);
