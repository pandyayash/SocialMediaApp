...
public class JobDetail_DBO implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
       ...
       // dest.writeList(this.followupWorkArrayList);
        dest.writeByte(this.isPending ? (byte) 1 : (byte) 0);
        dest.writeString(this.additional_inclusions);
        dest.writeParcelable((Parcelable) this.car_images, flags);
        dest.writeParcelable((Parcelable) this.car_videos, flags);
    }
...
//        this.followupWorkArrayList = new ArrayList<Model_FollowupWork>();
//        in.readList(this.followupWorkArrayList, Model_FollowupWork.class.getClassLoader());
