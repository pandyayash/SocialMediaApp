...
import technource.greasecrowd.model.DroppOffLocationDbo;
import technource.greasecrowd.model.LoginDetail_DBO;
import technource.greasecrowd.model.SubCatogoryDBO;

import static technource.greasecrowd.R.id.add;
import static technource.greasecrowd.R.id.edt_reg_number;
import static technource.greasecrowd.R.id.parentPanel;
import static technource.greasecrowd.R.string.year;

public class PostNewJobStepThree extends BaseActivity {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (status.equalsIgnoreCase(Constants.SUCCESS)) {
                                Intent intent = new Intent(PostNewJobStepThree.this, PostNewJobStepFour.class);
