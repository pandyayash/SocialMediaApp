...
public class EditJobStepFour extends BaseActivity {
    ...
    ArrayList<CarVideosDbo> carVideosDboArrayList;
    ...
    public class Favorite_Adapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.iv_image.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (model.getImage().contains("greasecrowd.com.au")) {
    ...
    public class Favorite_AdapterForVideo extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.iv_image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (model.getVideo() != null) {
                        if (model.getVideo().contains("greasecrowd.com.au")) {
            ...
            if (model.getThumbnail() != null) {
                if (model.getThumbnail().contains("greasecrowd.com.au")) {
                    Glide.with(appContext)
                            .load(model.getImage())
                            .asBitmap()
                            .diskCacheStrategy(DiskCacheStrategy.NONE)
