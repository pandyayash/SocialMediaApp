...
public class EditJobStepTwo extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent!=null){
            ...
            isPending = intent.getBooleanExtra("pending_job",false);
        }
        getviews();
...
//            }
    ...
    public void setAdapter() {
        ...
        for (int i=0;i<catogoriesDBOArrayList.size();i++){
            if (catogoriesDBOArrayList.get(i).getId().equalsIgnoreCase(jobDetail_dbo.getCategory_id())){
//
                catogoriesDBOArrayList.get(i).setSelected(true);
            }
        }
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (status.equalsIgnoreCase(Constants.SUCCESS)) {
                                ...
                                if (subCat!=0) {
                                    Intent intent = new Intent(appContext, EditJobStepThree.class);
    ...
    public class Recycleradapter extends RecyclerView.Adapter<Recycleradapter.Recycleviewholder> {
        ...
        public void onBindViewHolder(final Recycleradapter.Recycleviewholder holder, final int position) {
            ...
            if (!services.get(position).getItext().equalsIgnoreCase("")) {
                ...
                holder.ll_info.setVisibility(View.INVISIBLE);
            }
        }
