...
import technource.greasecrowd.fragment.FragmentDiscussionPrivate;
import technource.greasecrowd.fragment.FragmentDiscussionPublic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            if (intent.hasExtra("job_id") && intent.hasExtra("job_status")) {
                ...
                if (!(((DiscussionActivity) appContext).currentjobStatus.equalsIgnoreCase("Drop Off") || ((DiscussionActivity) appContext).currentjobStatus.equalsIgnoreCase("Complete") || ((DiscussionActivity) appContext).currentjobStatus.equalsIgnoreCase("Pickup"))) {
