...
public class AskTheCrowdStepTwo extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ask_the_crowd_step_two);
        getviews();
        getAndSetData();
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (status.equalsIgnoreCase(Constants.SUCCESS)) {
                                ...
                                if (subCat!=0) {
                                    Intent intent = new Intent(appContext, AskTheCrowdStepThree.class);
