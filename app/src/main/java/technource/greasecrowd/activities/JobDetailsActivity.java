...
public class JobDetailsActivity extends BaseActivity {
    ...
    public class CustomListAdapterOther extends RecyclerView.Adapter<CustomListAdapterOther.ViewHolder> {
        ...
        @Override
        public CustomListAdapterOther.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.list_review_responses, parent, false);

            return new CustomListAdapterOther.ViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(CustomListAdapterOther.ViewHolder holder, int position) {
