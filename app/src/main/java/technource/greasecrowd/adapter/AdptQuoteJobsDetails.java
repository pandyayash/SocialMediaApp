...
import technource.greasecrowd.activities.QuoteJobDetailsActivity;
import technource.greasecrowd.activities.QuoteJobDetailsPagerActivity;
...
//        holder.setDummyData();
        ...
        holder.txtDistance.setText("Distnace : " + awardJobDBOCarOwner.getDistance() + " KM");
