...
public class Constants {
    ...
    public static final String URL = "greasecrowd.com.au";
    public static String job_idBaseActivity;

    public static String Job_idBaseActivity;
    public static String cat_idBaseActivity;
    public static boolean isFromJobDetails;
    public static boolean isFromNewJobFeed=false;
    public static String notify_count;
    public static String notify_count_footer;
